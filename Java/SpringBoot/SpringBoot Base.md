...
将页面(所有的html文件)都作为静态资源，放在静态文件夹中(static)

![Xnip2022-06-26_14-12-47](SpringBoot.assets/Xnip2022-06-26_14-12-47.jpg)



获取验证码和注册按钮对应的功能都通过`js`发送`ajax`异步请求来实现:

![Xnip2022-06-26_14-15-54](SpringBoot.assets/Xnip2022-06-26_14-15-54.jpg)



![Xnip2022-06-26_14-17-30](SpringBoot.assets/Xnip2022-06-26_14-17-30.jpg)
...
编写验证码发送和检验的接口，以及其实现类:

![Xnip2022-06-26_14-19-21](SpringBoot.assets/Xnip2022-06-26_14-19-21.jpg)



![Xnip2022-06-26_14-19-34](SpringBoot.assets/Xnip2022-06-26_14-19-34.jpg)
...
创建实体类和jpa中用实体类对应表的接口:

- 其中实体类需要添加jpa注解来与表对应

![Xnip2022-06-26_14-25-06](SpringBoot.assets/Xnip2022-06-26_14-25-06.jpg)



- 注意在接口的泛型中注明实体类和主键的类型

![Xnip2022-06-26_14-23-57](SpringBoot.assets/Xnip2022-06-26_14-23-57.jpg)





创建添加用户的接口和实现类，通过自动注入之前的接口实现类来实现用户的创建:

![Xnip2022-06-26_15-26-08](SpringBoot.assets/Xnip2022-06-26_15-26-08.jpg)



创建一个单独的类作为返回给前端的数据(JSON)

![Xnip2022-06-26_14-29-43](SpringBoot.assets/Xnip2022-06-26_14-29-43.jpg)
...
通过注入`AccountRepository`和`VerifyService`接口的实现类在Controller中实现验证码发送与检验，以及用户的注册创建

![Xnip2022-06-26_15-27-06](SpringBoot.assets/Xnip2022-06-26_15-27-06.jpg)
