...
- 定义taco配料属性的领域类
- 获取配料信息，并将信息传递给视图的Spring MVC中的Controller类
- 在浏览器中渲染配料列表的视图模版
...
> 应用解决的主题范围: 会影响到应用理解的理念和概念



在我们的Taco Cloud应用中，`领域对象`包括:

taco设计、组成设计的配料、顾客以及顾客下的订单
...
每种taco的配料需要一个名称和类型，每种酱料还需要一个ID

Eg:

![Xnip2022-07-12_15-36-09](Spring实战.assets/Xnip2022-07-12_15-36-09.jpg)
