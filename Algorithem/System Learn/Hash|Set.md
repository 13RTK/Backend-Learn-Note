...
![Xnip2022-05-30_07-36-59](Hash|Set/Xnip2022-05-30_07-36-59.jpg)



![Xnip2022-05-30_07-34-09](Hash|Set/Xnip2022-05-30_07-34-09.jpg)
...
- 即前两个数组之和与后两个数组之和为0
- 那么我们只需要先记录前两个数组之和，再判断剩余两个数组之和的相反数是否存在于之前两个数组之和即可
- 所以我们需要做的就是记录下前两个数组每个和值对应频率，最后再通过后面两个数组的各个组合之和来统计对应的频率即可
