...
![Xnip2022-05-26_07-38-17](LinkedList/Xnip2022-05-26_07-38-17.jpg)



![Xnip2022-05-26_07-38-40](LinkedList/Xnip2022-05-26_07-38-40.jpg)
...
![Xnip2022-05-26_07-40-53](LinkedList/Xnip2022-05-26_07-40-53.jpg)
...
![Xnip2022-05-23_07-35-31](LinkedList/Xnip2022-05-23_07-35-31.jpg)

题意:

请你设计一个类，其维护了一个链表，可以实现CRUD功能



思路:

- 其实这道题就是考察对链表的操作罢了，不过这里我们可以选择用单链表实现，也可以使用双链表，区别就是双向链表在向链表尾添加节点时会更加简单而已
- 剩下的方法中，需要注意的无非就是对非法index的处理罢了
...
![Xnip2022-01-03_10-03-03](LinkedList/Xnip2022-01-03_10-03-03.jpg)



![Xnip2022-01-03_10-02-27](LinkedList/Xnip2022-01-03_10-02-27.jpg)

题意:
给你一个链表，再给你一个数字k，请你将链表尽量平均分为k组，其中最大组和最小组的长度差不超过1
...
- 既然需要k组，那么我们首先就需要一个长度为k的linkedlist数组
- 在分组的时候有多种情况：节点数 < k 或 节点数 = k 或 节点数 > k
- 等于还好说，每组遍历对应的次数后断开就是了，但另外两种呢？
- 这里有一个规律: 前reminder组的个数为quotient + 1，其中remainder是链表长度 / k的余数，quotient是商
- 这样一来，我们只需要加一个对index和remainder的大小判断，就能解决另外两种情况了
...
![Xnip2022-01-04_08-56-18](LinkedList/Xnip2022-01-04_08-56-18.jpg)



![Xnip2022-01-04_09-12-10](LinkedList/Xnip2022-01-04_09-12-10.jpg)

题意:

给你一个链表，一个数字m和n，请你保留前m个节点后删除n个节点，重复该步骤直到链表尾
...
- 对于每个部分，只需要将需要的部分链接起来即可，所以我们需要先跳过需要保留的部分，再用另一个指针跳过需要删除的部分，之后将两个部分连接起来即可
...
![Xnip2022-01-05_14-50-59](LinkedList/Xnip2022-01-05_14-50-59.jpg)



![Xnip2022-01-05_14-58-08](LinkedList/Xnip2022-01-05_14-58-08.jpg)

题意:

给你一个按照节点值绝对值排序的链表，请你将其中的节点按照节点值重新排列
...
- 该题目本质上是对链表进行排序，所以我们可以使用归并排序，但这样就没有利用任何原链表的特性了，那么运用原链表特性的话可以怎么做呢？
- 因为原链表是按照节点值的绝对值排序的，所以绝对值大的在右边
- 我们要做的所谓的排序，其实就是将负数节点都移到左边即可，此时右边的正数节点自然就排好序了
- 那么如何保证左边的负数节点也是排好序的呢？
- 其实我们只需要按照从左到右的顺序遍历节点，每当遍历到负数节点时都移到你链表头即可，因为最小的负数一定在最右边(绝对值大)
...
![Xnip2022-01-06_21-59-08](LinkedList/Xnip2022-01-06_21-59-08.jpg)



![Xnip2022-01-06_22-05-12](LinkedList/Xnip2022-01-06_22-05-12.jpg)

题意:

给你一个链表，将最后一个节点的值 + 1，将该链表作为一个数，返回加1后的结果
...
- 看起来需要我们从后面开始处理，其实我们只需要进行反转即可
- 而 +1操作可以看作是和一个长度为1的链表相加(其中唯一一个节点的值为1)
- 获取两个链表的和之后再反转即可
...
- 我们翻转了两次链表，又遍历了一次，所以时间复杂度为O(n)
- 我们存储了相加后的结果链表，所以空间复杂度为O(n)
...
![Xnip2022-01-07_13-56-11](LinkedList/Xnip2022-01-07_13-56-11.jpg)



![5376570F-1E25-44BC-8656-37B27999EF23](LinkedList/5376570F-1E25-44BC-8656-37B27999EF23.png)
