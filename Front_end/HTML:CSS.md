...
- Cascading Style Sheets，是一种样式表语言，用来描述HTML、XML(XHTML之类的XML分支语言)
- 描述了其他元素被如何渲染的问题
...
![Xnip2021-11-25_21-10-49](HTML:CSS/Xnip2021-11-25_21-10-49.jpg)

- 这种方式的代码量很大，复用性不好(只能重复cv)
...
- 通过style标签指定样式，在其中写对应的css内容

![Xnip2021-11-25_21-20-13](HTML:CSS/Xnip2021-11-25_21-20-13.jpg)

- 这种方法只能在一个html页面中生效，同样不能复用
...
- 创建一个独立的css文件
- 通过link标签将该css文件引入(ref属性指定路径)

Eg:

![Xnip2021-11-25_21-29-07](HTML:CSS/Xnip2021-11-25_21-29-07.jpg)
...
- 在css中使用#id值作为选择器的名称
- 需要在标签中应用该样式时，只需要在id属性中设置相同的id值即可

Eg:

![Xnip2021-11-25_21-44-05](HTML:CSS/Xnip2021-11-25_21-44-05.jpg)
...
- 在css中将选择器写为".class + 值"
- 在需要使用的标签中设定class属性值为class + 值

![Xnip2021-11-25_21-49-25](HTML:CSS/Xnip2021-11-25_21-49-25.jpg)
...
- 可在选择器名上同时写类选择器和id选择器

Eg:

![Xnip2021-11-25_21-52-28](HTML:CSS/Xnip2021-11-25_21-52-28.jpg)
